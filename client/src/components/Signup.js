...
import { MdLockOutline, MdPersonOutline, MdMailOutline } from "react-icons/md";
...
function Signup({ setCurrentUser }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const response = await fetch("https://explor.onrender.com/signup", {
        method: "POST",
    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-orange-50 to-white py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800">Join Explorr</h1>
        ...
        >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link
                to="/login"
                className="text-[#FB8500] hover:text-orange-600 font-medium"
              >
                Log in instead
              </Link>
            </p>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            ...
            >
              ...
              >
                ...
                />
                <path
                  d="M12 23C14.97 23 17.46 22.02 19.28 20.34L15.71 17.57C14.73 18.23 13.48 18.63 12 18.63C9.19 18.63 6.8 16.76 5.93 14.21H2.25V17.07C4.06 20.62 7.76 23 12 23Z"
                  fill="#34A853"
                />
                <path
                  d="M5.93 14.21C5.7 13.55 5.57 12.84 5.57 12.11C5.57 11.38 5.7 10.67 5.93 10.01V7.15H2.25C1.46 8.71 1 10.36 1 12.11C1 13.86 1.46 15.51 2.25 17.07L5.93 14.21Z"
                  fill="#FBBC05"
                />
                <path
                  d="M12 5.59C13.62 5.59 15.06 6.12 16.21 7.23L19.36 4.08C17.45 2.29 14.97 1.11 12 1.11C7.76 1.11 4.06 3.49 2.25 7.04L5.93 9.9C6.8 7.35 9.19 5.59 12 5.59Z"
                  fill="#EA4335"
                />
              </svg>
              Google
